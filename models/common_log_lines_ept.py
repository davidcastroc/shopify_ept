...
class CommonLogLineEpt(models.Model):
    ...
    shopify_export_metafields_queue_line_id = fields.Many2one("shopify.export.metafields.queue.line.ept",
                                                         "Shopify Export Metafields Queue Line")
    ...
    def search_existing_record(self, **kwargs):
        ...
        record_id = self.search([('shopify_instance_id', '=', kwargs.get('shopify_instance_id')),
                                 ...
                                 ('shopify_export_metafields_queue_line_id', '=',
                                  kwargs.get('shopify_export_metafields_queue_line_id'))
                                 ])
        return record_id
