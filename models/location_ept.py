...
class ShopifyLocationEpt(models.Model):
    ...
    restock_warehouse_id = fields.Many2one(
        "stock.warehouse",
        string="Restock Warehouse",
        help="Used to resolve Shopify location for return restocking flow from Odoo return pickings."
    )
